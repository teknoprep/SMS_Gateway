...
define("CONS_VENDOR", FCPATH . "code_app/vendor/autoload.php");

/** SMS API Configuration */
define("CONS_TWILIO_SID", "");
define("CONS_TWILIO_AUTH_TOKEN", "");
define("CONS_PLIVO_AUTH_ID", "");
