            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?= base_url() ?>/admin/user"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="<?= base_url() ?>/admin/user/insert">Add New User</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <form action="<?= base_url() ?>/admin/user/update" method="post" enctype="multipart/form-data">
                                    ...
                                    <!--   <div class="form-group">
                                        ...
                                        <select name="ddlabel" id="ddlabel" class="form-control">
                                            <option value="">Select Label</option>
                                            <?php // foreach ($labels as $row) : 
                                            ?>

                                                <option value="<?php // $row['label_id'] 
                                                                ?>" <?php // ($update['label_id'] == $row['label_id']) ? "selected" : "" 
                                                                    ?>><?php // $row['label_name'] 
                                                                        ?></option>
                                            <?php //endforeach; 
                                            ?>
