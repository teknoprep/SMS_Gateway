                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?= base_url() ?>/admin/carrier/insert">Add New Carrier</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form action="<?= base_url() ?>/admin/carrier/insert" method="post" enctype="multipart/form-data">
