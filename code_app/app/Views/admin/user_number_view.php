                                                ...
                                                <?php foreach ($numbers->getResult() as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?= base_url()  ?>/admin/user/numberdelete/<?= md5($row->un_id); ?>">Delete</a> |

                                                            <?php if ($row->is_active == 1) : ?>
                                                                <a href="<?= base_url()  ?>/admin/user/numberstatus/<?= md5($row->un_id); ?>/0/<?= $id ?>">
                                                                    <?= 'Disable' ?>
                                                                </a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url()  ?>/admin/user/numberstatus/<?= md5($row->un_id); ?>/1/<?= $id ?>">
                                                                    <?= 'Enable' ?>
                                                                </a>
                                                            <?php endif; ?>
