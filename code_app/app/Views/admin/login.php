...
<head>
    ...
    <title>SMS Gateway | Admin Panel | Login</title>
    <meta charset="utf-8">
            ...
            <div class="row align-items-center text-center">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <p class="mb-2 text-muted">Forgot password? <a href="<?php base_url() ?>/admin/login/reset_password" class="f-w-400">Reset</a></p>
