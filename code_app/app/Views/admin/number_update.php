                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <form action="<?= base_url() ?>/admin/number/update" method="post" enctype="multipart/form-data">


                                    <div class="form-group">
                                        <number>Number</number>
                                        <input type="text" class="form-control" name="number" value="<?= $update['number'] ?>" />
                                    </div>

                                    <div class="form-group">
                                        <number>Number Label</number>
                                        <input type="text" class="form-control" name="number_label" value="<?= $update['number_label'] ?>" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="carrier_id" id="carrier_id" class="form-control">
                                            ...
                                            <?php foreach ($carriers as $row) : ?>
                                                <option value="<?= $row['carrier_id'] ?>" <?= ($update['carrier_id'] == $row['carrier_id'] ? 'selected' : '') ?>><?= $row['name'] ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    ...
                                    <input type="hidden" name="number_id" value="<?= $update['number_id'] ?>">
